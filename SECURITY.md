...
If you find a security vulnerability in CLI Finance, please report it through [GitHub's private vulnerability reporting](https://github.com/IoannisDev/CLI-Finance/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact N/A for details.
